...
import { useIsMobile } from "@07nghiep/ui/hooks/use-mobile";
...
import { Tooltip, TooltipContent, TooltipTrigger } from "@07nghiep/ui/components/tooltip";
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Persisting this UI preference matches shadcn sidebar behavior.
