  ...
  return (
    <div className="min-h-screen bg-secondary/30 px-4 py-8">
      <div className="container mx-auto max-w-6xl">
        {/* Welcome Section */}
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold">Chào mừng, Nhà tuyển dụng</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <Link
                to="/"
                className="inline-flex w-full items-center gap-3 rounded-md border border-border bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/80"
              >
              ...
              <Link
                to="/"
                className="inline-flex w-full items-center gap-3 rounded-md border border-border bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-muted"
              >
