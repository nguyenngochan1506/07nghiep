    ...
    <div className="flex min-h-svh items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md p-8">
        <div className="mb-8 text-center">
          <h1 className="mb-2 text-2xl font-bold">Tạo tài khoản nhà tuyển dụng</h1>
          <p className="text-sm text-muted-foreground">Đăng ký để bắt đầu đăng tin tuyển dụng</p>
        </div>
